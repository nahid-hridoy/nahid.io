            ...
            case 'IcosahedronGeometry':
                if (currentcolor == 0xF66120) {
                    if (planetViewed == 0) {
                        ...
                        info.innerHTML = "I'm <span>Nahid</span>  Mahamud,";
                        subtitle.innerHTML = "a <span>web developer &amp; graphic designer</span> from Dhaka, Bangladesh.";
                        description.innerHTML = "I'm working as a freelancer at <span>Upwork.</span><br/><br/><div>Click on the other planets to learn more ...<div>";
                    }
                ...
                if (currentcolor == 0x26D7E7) {
                    if (planetViewed == 1 || planetViewed==3 || planetViewed==4) {
                        planetViewed = 2;
                        info.innerHTML = '<span id="couleur">Web</span> Developer ';
                        document.getElementById('couleur').style.color="#26D7E7";
                        subtitle.innerHTML = "Since <span>February 2012</span>.";
                        description.innerHTML = "You can find all my projects here :  <br/><a target='_blank' href='http://bit.ly/nmh47-website-projects'>View Projects</a><br/><br/><div>Click on the other planets to learn more ...<div>";
                   ...
                   if (currentcolor == 0xffc12d) {
                    if (planetViewed == 1 || planetViewed==2 || planetViewed==4) {
                        planetViewed = 3;
                        info.innerHTML = '<span id="couleur">Graphic </span> Designer ';
                         document.getElementById('couleur').style.color="#ffc12d";
                        subtitle.innerHTML = "Since <span>August 2012</span>.";
                        description.innerHTML = "You can find all my projects here :  <br/><a target='_blank' href='http://bit.ly/2FYtxap'>View Projects</a><br/><br/><div>Click on the other planets to learn more ...<div>";
                    ...
                    if (planetViewed == 1 || planetViewed==2 || planetViewed==3) {
                        planetViewed = 4;
                        info.innerHTML = '<span id="couleur">Thesis</span> Paper <div>: ALW Drone<div> ';
                         document.getElementById('couleur').style.color="#acacac";
                        subtitle.innerHTML = "Published On <span>IEEE Xplore</span> In <span>February 2017</span> .";
                        description.innerHTML = "View Thesis paper-<a target='_blank' href='http://bit.ly/2vbFEeG'>ALW drone: A new design and efficient approach</a><br></br><div>Click on the other planets to learn more ...<div>";
